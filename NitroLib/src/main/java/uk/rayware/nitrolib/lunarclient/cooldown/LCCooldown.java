package uk.rayware.nitrolib.lunarclient.cooldown;

import uk.rayware.nitrolib.lunarclient.net.packets.client.LCPacketCooldown;
import uk.rayware.nitrolib.lunarclient.util.LCPacketWrapper;

...
import gbo.forever.spigot.commons.ConcurrentIntHashMap;
import gbo.forever.spigot.config.WindSpigotConfig;

public class EntityTracker {

	private Set<EntityTrackerEntry> c = Sets.newHashSet(); // GBO start
	public List<EntityTrackerEntry> oldSet = Lists.newCopyOnWriteArrayList(); // GBO end
	...
	// GBO add getter
	public Set<EntityTrackerEntry> getC() {
		return c;
	}

	// GBO add setter
	public void setC(Set<EntityTrackerEntry> c) {
		this.c = c;
	}

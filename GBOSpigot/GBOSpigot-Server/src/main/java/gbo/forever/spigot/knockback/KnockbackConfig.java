package gbo.forever.spigot.knockback;
...
public class KnockbackConfig {
	...
	public static void init(File configFile) {
		...
		try {
			GBOSpigot.LOGGER.info("Loading WindSpigot knockback config from " + configFile.getName());
		...
		if (currentKb == null) {
			GBOSpigot.LOGGER.warn("Knockback profile selected was not found, using profile 'kohi' for now!");
			currentKb = getKbProfileByName("kohi");
			
			GBOSpigot.LOGGER.info("Setting default knockback as 'kohi'...");
